  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <main className="max-w-xl mx-auto px-6 py-20 text-center">
        <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6" style={{ background: GREEN_LIGHT }}>
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-3">{t.support.title}</h1>
        <p className="text-gray-500 mb-10 leading-relaxed">{t.support.subtitle}</p>
        ...
        <a
          ...
          style={{ background: GREEN, boxShadow: '0 8px 24px rgba(42,187,111,0.35)', textDecoration: 'none' }}
      ...
      <footer className="border-t border-gray-100 py-10 bg-[#FAFAFA]">
        <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-5">
          <Link to="/" className="text-2xl font-bold" style={{ color: GREEN, letterSpacing: '-0.5px', textDecoration: 'none' }}>sagi</Link>
